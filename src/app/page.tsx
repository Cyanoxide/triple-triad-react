  ...
  return (
    <>
      ...
      {session && isGameActive && !isRewardSelectionOpen && (
        <div className="absolute left-[var(--furniture-left)] bottom-[var(--furniture-bottom)] text-3xl z-10" data-app-scaled>
      ...
      {session && isGameActive && !isRewardSelectionOpen && (
        <div className="absolute right-[var(--furniture-right)] top-[var(--furniture-top)] text-3xl z-10 pointer-events-none" data-app-scaled>
          <AutoplayTimer />
        </div>
      )}
      ...
      <div className="absolute right-[var(--furniture-right)] bottom-[var(--furniture-bottom)] text-3xl z-[11] flex items-center" data-app-scaled>
